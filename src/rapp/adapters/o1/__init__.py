...
See also
    :class:`rapp.application.ports.O1Port` — structural typing Protocol used
...
class O1Client(ABC):
    ...
    Any concrete implementation also satisfies the structural
    :class:`rapp.application.ports.O1Port` Protocol.
    """
