...
Adapter role
    ...
    .. code-block:: none
        ...
        [O-RAN R1 ICS REST JSON] <── ICSAdapter ──> [core.models.KpiReport]
...
See also
    :class:`rapp.application.ports.R1SMEPort`,
    :class:`rapp.application.ports.R1ICSPort` — structural typing Protocols
