...
into the standard :class:`~models.parameters.ThreeGPPKpi` identifiers,
...
class GnbTelemetryAdapter:
    ...
    Uses :class:`~models.parameters.ThreeGPPKpi` enum values for all
    ...
    :param node_type: :class:`~models.parameters.NodeType` of the managed node.
    ...
    def get_kpi_report(self, cell_id: str, gnb_id: str = "") -> KpiReport:
        """Build a complete :class:`~models.KpiReport` for a cell.
