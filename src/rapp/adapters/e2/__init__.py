...
See also
    :class:`rapp.application.ports.E2KpmPort`,
    :class:`rapp.application.ports.E2RcPort`
"""
...
class E2Indication:
    ...
    :param pm_counters: 3GPP PM counter name → value mapping.
        Keys are :class:`~core.models.parameters.ThreeGPPKpi` values.
...
class E2SmKpmAdapter:
    """Adapts E2SM-KPM indications to :class:`~core.models.KpiReport`.

    Decodes the raw PM counter payload from the E2 node and normalises it
    to the BMW Lab :class:`~core.models.KpiReport` data model.
    ...
    def subscribe(self, cell_id: str, interval_ms: int = 1000) -> str:
        ...
        return self._client.subscribe_kpm(
            self._ran_function_id, cell_id, interval_ms
        )
    ...
    def indication_to_kpi_report(self, indication: E2Indication) -> KpiReport:
        """Convert an :class:`E2Indication` to a :class:`~core.models.KpiReport`.

        Maps E2SM-KPM PM counter names (3GPP TS 28.552) directly to
        :class:`~core.models.KpiReport` fields.
...
class E2SmRcAdapter:
    """Adapts :class:`~core.models.PolicyDecision` to E2SM-RC control requests.
    ...
    _DEFAULT_ACTION_IDS: dict[PolicyDecision, int] = {
    ...
    def apply_decision(
        ...
        :param cell_id: Target cell NR CGI.
        :param decision: :class:`~core.models.PolicyDecision` to enforce.
        ...
        _log.info(
            ...
            cell_id, decision.value, action_id,
        )
