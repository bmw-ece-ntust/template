...
BMW Lab SOP source-code-guide Section 8.
...
class KpiReport:
    ...
    :param avg_power_w:
        Mean PNF power consumption in watts
        (`PEE.AvgPower
        <https://www.3gpp.org/ftp/Specs/archive/28_series/28.552/28552-i50.zip>`_,
        TS 28.552 §5.1.1.19.2.1, p.64).  Drives energy-saving strategies.
    :param energy_kwh:
        PNF energy consumed over the granularity period in kWh
        (`PEE.Energy
        <https://www.3gpp.org/ftp/Specs/archive/28_series/28.552/28552-i50.zip>`_,
        TS 28.552 §5.1.1.19.3, p.65).
    """
    ...
    _FIELD_BY_KPI: ClassVar[dict[ThreeGPPKpi, str]] = {
        ...
        ThreeGPPKpi.PEE_AVG_POWER: "avg_power_w",
        ThreeGPPKpi.PEE_ENERGY: "energy_kwh",
    }
